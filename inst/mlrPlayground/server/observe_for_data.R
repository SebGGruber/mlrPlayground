...
observe({
  ...
  runif_noise     = runif(amount, -1, 1) * noise
  ...
  data = {
    ...
    } else if (task == "3.Two Circle + Point") {
    ...
    } else if(task == "8.Amplification Sine"){
    ...
    } else if(task == "1.Normal Points + Uniform Square"){
    ...
    } else if(task == "6.Parabola + Two Points"){
